...
import org.example.appointmentmanagementapp.service.AppointmentService;
...
import org.example.appointmentmanagementapp.service.SurgeryService;
...
public class AppointmentmanagementappApplication implements CommandLineRunner {
	...
	public AppointmentmanagementappApplication(DentistService dentistService, PatientService patientService, SurgeryService surgeryService, AppointmentService appointmentService, UserRepository userRepository, PasswordEncoder passwordEncoder,RoleRepository roleRepository){
	...
	public void run(String... args) throws Exception {
		Role role=new Role(null, "PATIENT", null);
		roleRepository.save(role);
		User user=new User(null, "Adam", "Smith", "+18415551221", "tony@gmail.com", passwordEncoder.encode("12345678"), LocalDate.of(1991,07,26), List.of(new Role(null,"admin", null)), true,true,true,true);
